...
use crate::mod_database::{
    common::DatabaseCommonOperations, constants::ChunkStatus, impl_database::Database, constants_sql,
    schema::ArchiveChunk,
};
...
impl ArchiveChunkDao {
    ...
    pub fn insert_archive_chunk(&self, chunk: &ArchiveChunk) -> SqliteResult<i64> {
        ...
        self.conn.execute(
            constants_sql::archive_chunk::INSERT,
            rusqlite::params![
                chunk.archive_id,
                chunk.chunk_name,
                chunk.chunk_size,
    ...
    pub fn update_archive_chunk(&self, chunk: &ArchiveChunk) -> SqliteResult<()> {
        self.conn.execute(
            constants_sql::archive_chunk::UPDATE,
            rusqlite::params![
                chunk.archive_id,
                chunk.chunk_name,
                chunk.chunk_size,
    ...
    pub fn find_archive_chunk_by_id(&self, id: i64) -> SqliteResult<Option<ArchiveChunk>> {
        self.conn
            .query_single(constants_sql::archive_chunk::SELECT_BY_ID, rusqlite::params![id])
    }
    ...
    pub fn find_archive_chunks_by_archive_id(
        ...
        self.conn.query_multiple(
            constants_sql::archive_chunk::SELECT_BY_ARCHIVE_ID,
    ...
    pub fn find_archive_chunks_by_status(
        ...
        self.conn.query_multiple(
            constants_sql::archive_chunk::SELECT_BY_STATUS,
    ...
    pub fn find_by_chunk_hash(
        ...
        self.conn.query_single(
            constants_sql::archive_chunk::SELECT_BY_CHUNK_HASH,
