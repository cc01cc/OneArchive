...
public class DatabaseAccessor {
    ...
    public List<InfoRoot> findAllRootInfo() {
        return jdbi.withExtension(CommonDao.class, CommonDao::findAllInfoRoots);
    }
    ...
    public List<InfoRoot> getHealthRootDirList() {
        try {
            return jdbi.withExtension(CommonDao.class, CommonDao::getHealthRootDirList);
        } catch (Exception e) {
