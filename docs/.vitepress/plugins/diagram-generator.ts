      ...
      if (!fs.existsSync(outPath)) {
        ...
        try {
          if (lang === 'plantuml') {
            ...
            try {
              execSync(`npx plantuml-cli "${tmp}" -tsvg -o "${outDir}" -DPLANTUML_LIMIT_SIZE=16384 -DdefaultFontSize=14 -DdefaultFontName="DejaVu Sans, WenQuanYi Micro Hei, Noto Sans CJK SC, sans-serif" -DminimumWidth=200 -Ddpi=150`, { stdio: 'inherit' })
